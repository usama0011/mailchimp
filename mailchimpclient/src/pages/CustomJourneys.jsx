            ...
            <header className="root-1rj4d standard-2H4cn header-3IL6q">
              <div className="cluster-3D5Qr nowrap-34OZ-">
                <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                  <div className="stack-1qp4V style-dPB1n" id="style-dPB1n">
                    <nav aria-labelledby="mc:102" className="breadcrumbs-1_9F-">
                    ...
                    <h1 className="heading-4-3r-mu root-PihPG">My Journeys</h1>
                  </div>
                </div>
              </div>
              <div></div>
              <div className="actions-1bN9W cluster-3D5Qr">
                <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                  ...
                  >
                    <span className="temporarySpan-2iF2p">Build from scratch</span>
                  </a>
                  <a
            ...
            >
              ...
              <div className="stack-1qp4V spacing6-nznRY emptyContent-QBkQN">
                ...
                <p className="root-3TDqk medium-3AcAC bodyText-1xftB">
                  Deliver great experiences with Customer Journeys. Automated
                  marketing helps you reach more customers with less effort and more
                  results.
                </p>
                <div>
                  <a
