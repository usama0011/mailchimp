...
import '../styles/SignupEmbadedForm.css'
const SignUpEmbaddedForm = () => {
  return (
    <div class="wink snipcss-plfI7">
      ...
      <div class="frontDoorRow-2yluE">
        <div class="navigation-2_SUj navigationOpenDesktop-1gZ8o">
          ...
          >
            <div role="listitem" class="container-IL_ti">
              ...
              <div>
                <div id="style-viphG" class="style-viphG">
                  <ul id="mc:41">
                    <div role="listitem">
        ...
        <div class="content-1h3tW snipcss0-0-0-1 snipcss-U3rGd">
          <div
            class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK snipcss0-1-1-2 tether-element-attached-top tether-element-attached-center tether-target-attached-top tether-target-attached-center"
            id="front-door-content"
          >
            <div class="container-1xp3H">
            <div class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK contentTextScroll-1kb9h snipcss-LTqBN" id="front-door-content">
    <p class="root-3TDqk small-bold-6R-6E">EMBEDDED FORM</p>
    <h1 class="heading-1-2zF42 heading-1maYK root-PihPG">Grow your audience with an embedded signup form</h1>
    <p class="root-3TDqk medium-3AcAC subHeading-16sBT">Gather customer information how you like by creating a customizable form that can be embedded onto any website.</p>
    <p class="root-3TDqk medium-secondary-1YIN8 helpText-2Z_SU">Learn how to <a href="https://mailchimp.com/help/all-the-segmenting-options/" target="_blank" rel="noopener noreferrer">organize your audience into segments</a> based on contact signup source.</p><button class="root-sBgFt container-3-bH7 primary-33czz button-2cCi-" type="button"><span class="temporarySpan-2iF2p">Begin</span></button><img src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/language-agnostic-assets/in-app-pages/create/signup-forms/embedded-form.png" alt="A brand image on top of a short form with an engagement widget to the right" aria-hidden="false" class="image-2QFvP"/>
</div>
            </div>
          </div>
        </div>
...
export default SignUpEmbaddedForm