...
import '../styles/AbandoneCart.css'
const AbandonedCart = () => {
  return (
    ...
    <div class="frontDoorRow-2yluE">
      ...
      <div class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK snipcss0-0-0-1 snipcss-zjgJC" id="front-door-content">
    <p class="root-3TDqk small-bold-6R-6E">POSTCARD</p>
    <h1 class="heading-1-2zF42 heading-1maYK headingNarrow-HmUjz root-PihPG">Send an abandoned cart postcard</h1>
    <p class="root-3TDqk medium-3AcAC subHeading-16sBT">Send a printed postcard to give your shoppers an extra nudge to get back to your store.</p><button class="root-sBgFt container-3-bH7 primary-33czz button-2cCi-" type="button"><span class="temporarySpan-2iF2p">Connect Your Store</span></button><img src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/language-agnostic-assets/in-app-pages/create/postcard/google-remarketing-ad.png" alt="Items for sale overlaid with cart reminder, checkout, and delivery widgets" aria-hidden="false" class="image-2QFvP"/>
</div>
      </div>
    </div>
  </div>
