    ...
    <div class="wink snipcss-plfI7">
      ...
      <div class="frontDoorRow-2yluE">
        ...
        <div class="content-1h3tW snipcss0-0-0-1 snipcss-U3rGd">
          <div
            class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK contentTextScroll-1kb9h snipcss-xvzQK"
            id="front-door-content"
          >
            <p class="root-3TDqk small-bold-6R-6E">SURVEYS</p>
            <h1 class="heading-1-2zF42 heading-1maYK root-PihPG">
              Go from responses to results
            </h1>
            <p class="root-3TDqk medium-3AcAC subHeading-16sBT">
              Our surveys let you target, gather, and manage customer feedback
              that can turn reviews and requests into research-based products
              and services.
            </p>
            <button
            ...
            <img
              src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/language-agnostic-assets/in-app-pages/create/surveys/create-a-survey.png"
              alt="A purchased item being rated on the left and a survey being sent on the right"
              aria-hidden="false"
              class="image-2QFvP"
            />
          </div>
