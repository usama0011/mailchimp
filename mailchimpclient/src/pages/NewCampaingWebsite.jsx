...
// import "../styles/NewCampaingWebsite.css";
const NewCampaingWebsite = () => {
  return (
    <div class="wink snipcss-plfI7">
      ...
      <div class="frontDoorRow-2yluE">
        ...
        <div class="content-1h3tW snipcss-6aAqn">
          <div
            class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK tether-element-attached-top tether-element-attached-center tether-target-attached-top tether-target-attached-center"
            id="front-door-content"
          >
            <p class="root-3TDqk small-bold-6R-6E">WEBSITE</p>
            <h1 class="heading-1-2zF42 heading-1maYK root-PihPG">
              Easily build your online presence
            </h1>
            <p class="root-3TDqk medium-3AcAC subHeading-16sBT">
              Create a free website with all the tools needed to market your
              business built right in. No coding skills needed.
            </p>
            <button
              class="root-sBgFt container-3-bH7 primary-33czz button-2cCi-"
              type="button"
            >
              <span class="temporarySpan-2iF2p">Get started</span>
            </button>
            <img
              src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/language-agnostic-assets/in-app-pages/create/website/website-child.png"
              alt="A professional and polished brand website that is being edited in the lower right-hand corner"
              aria-hidden="false"
              class="image-2QFvP"
            />
          </div>
...
export default NewCampaingWebsite;
