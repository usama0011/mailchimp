...
// import "../styles/EmailRegular.css";
const EmailRegular = () => {
  return (
          ...
          >
            <div class="container-1xp3H">
              ...
              <p class="root-3TDqk medium-3AcAC subHeading-1b7r4">
                Keep your subscribers engaged by sharing your latest news,
                promoting a line of products, or announcing an event.
              </p>
              <form
              ...
              >
                <div class="root-2RFjU emptyAudience-13cLy">
                  <div class="before-2EDUs">
                    <label class="mcds-label-default" id="mc:105" for="mc:104">
                      Internal email name
                    </label>
                  </div>
