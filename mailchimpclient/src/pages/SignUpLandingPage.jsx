...
import "../styles/SignupLandingpage.css";
    ...
    <div class="wink snipcss-plfI7">
      ...
      <div class="frontDoorRow-2yluE">
        ...
        <div class="content-1h3tW snipcss0-0-0-1 snipcss-U3rGd">
          <div
            class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK snipcss-KyRAW"
            id="front-door-content"
          >
            <div class="container-1xp3H">
              <h1 class="heading-1-2zF42 heading-vLHyh root-PihPG">
                Grow your audience with a signup landing page
              </h1>
              <p class="root-3TDqk medium-3AcAC subHeading-1b7r4">
                Collect email addresses in exchange for a giveaway or free
                download, or invite people to join your audience by announcing a
                pre-sale.
              </p>
              <form
              ...
              >
                <div class="root-2RFjU">
                  <div class="before-2EDUs">
                    <label class="mcds-label-default" id="mc:172" for="mc:171">
                      Landing page name
                    </label>
                  </div>
                ...
                <div class="root-1cS4q">
                  <div class="before-fjpii">
                    <label class="mcds-label-default" id="mc:177" for="mc:176">
                      Select An Audience
                    </label>
                  </div>
                  <div class="selectWrapper-1gG6j">
                    <select id="mc:176" name="selectValue">
