...
import "../styles/SignupPopupForm.css";
        ...
        <div class="content-1h3tW snipcss0-0-0-1 snipcss-U3rGd">
          ...
          >
            <div class="container-1xp3H">
              <div
                class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK snipcss0-1-1-2 snipcss-NUBA7"
                id="front-door-content"
              >
                <div class="container-1xp3H snipcss0-2-2-3">
                  <h1 class="heading-1-2zF42 heading-vLHyh root-PihPG snipcss0-3-3-4">
                    Grow your audience with a pop-up signup form
                  </h1>
                  <p class="root-3TDqk medium-3AcAC subHeading-1b7r4 snipcss0-3-3-5">
                    Give your website visitors a chance to stay in touch. Add a
                    pop-up form to your site and collect new contacts up to 50%
                    faster.
                  </p>
                  <form
                    class="stack-1qp4V spacing6-nznRY snipcss0-3-3-6"
                    novalidate=""
                    id="form-9n6ul"
                  >
                    <div class="root-1cS4q snipcss0-4-6-7">
                      <div class="before-fjpii snipcss0-5-7-8">
                        <label
                          class="mcds-label-default snipcss0-6-8-9"
                          id="mc:142"
                          for="mc:141"
                        >
                          Select An Audience
                      ...
                      <div class="selectWrapper-1gG6j snipcss0-5-7-10">
                        <select
                          id="mc:141"
                          name="selectValue"
                          class="snipcss0-6-10-11"
                        >
                          <option value="4955578" class="snipcss0-7-11-12">
                            Next Web Lines
                          </option>
                        </select>
                        <div class="indicator-3GTSs snipcss0-6-10-13">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            focusable="false"
                            aria-hidden="true"
                            class="wink-icon snipcss0-7-13-14"
                          >
                            <path
                              fill-rule="evenodd"
                              clip-rule="evenodd"
                    ...
                    <p class="root-3TDqk medium-3AcAC selectSubLabel-1EJaA snipcss0-4-6-15">
                      You'll be able to segment your audience by signup source
                      to target people who subscribe from your popup form.
                    </p>
                    <div class="button-1iD64 snipcss0-4-6-16">
                      <button
                        class="root-sBgFt container-3-bH7 primary-33czz button-3mfLr snipcss0-5-16-17"
                        type="submit"
                      >
                        <span class="temporarySpan-2iF2p snipcss0-6-17-18">
                          Begin
                        </span>
                      </button>
                    </div>
