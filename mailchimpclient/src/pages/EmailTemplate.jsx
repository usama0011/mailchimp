  ...
  return (
    <div class="wink snipcss-plfI7">
      ...
      <div class="frontDoorRow-2yluE">
        ...
        <div class="content-1h3tW snipcss0-2-3-78 snipcss-idRQS">
          <div
            class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK snipcss0-3-78-79"
            id="front-door-content"
          >
            <p class="root-3TDqk small-bold-6R-6E">EMAIL TEMPLATES</p>
            <h1 class="heading-1-2zF42 heading-1maYK root-PihPG">
              Get a head start on your email design
            </h1>
            <p class="root-3TDqk medium-3AcAC subHeading-16sBT">
              Start with one of our templates, then make it your own.
            </p>
            <button
            ...
            <img
              src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/language-agnostic-assets/in-app-pages/create/email/template.png"
              alt="Four mobile screens displaying stylish templates for different brands"
              aria-hidden="false"
              class="image-2QFvP"
            />
          </div>
