  ...
  return (
    <div class="wink snipcss-plfI7">
      ...
      <div class="frontDoorRow-2yluE">
        ...
        <div
          class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK contentTextScroll-1kb9h snipcss-aX5XQ"
          id="front-door-content"
        >
          <br />
          <p class="root-3TDqk small-bold-6R-6E">AUTOMATIONS</p>
          <h1 class="heading-1-2zF42 heading-1maYK root-PihPG">
            Create custom, automated messages
          </h1>
          <p class="root-3TDqk medium-3AcAC subHeading-16sBT">
            Send timely and personalized emails without having to hit the send
            button each time.
          </p>
          <button
          ...
          <img
            src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/language-agnostic-assets/in-app-pages/create/automations/customerJourneys.png"
            alt="A smartphone showing a brand page with automation features from Mailchimp on the left-hand side"
            aria-hidden="false"
            class="image-2QFvP"
          />
        </div>
