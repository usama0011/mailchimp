    ...
    <div class="wink snipcss-plfI7">
      ...
      <div class="frontDoorRow-2yluE">
        ...
        <div class="content-1h3tW snipcss0-0-0-1 snipcss-U3rGd">
          <div
            class="stack-1qp4V contentText-2ARRa contentTextOpenDesktop-3FWWK snipcss0-0-0-1 snipcss-zdKYI"
            id="front-door-content"
          >
            <div class="container-1xp3H">
              <h1 class="heading-1-2zF42 heading-vLHyh root-PihPG">
                Send a recurring postcard
              </h1>
              <p class="root-3TDqk medium-3AcAC subHeading-1b7r4">
                Schedule a recurring postcard campaign to send your contacts
                reminders, coupons, and other messages at regular intervals.
              </p>
              <form
              ...
              >
                <div class="root-2RFjU emptyAudience-13cLy">
                  <div class="before-2EDUs">
                    <label class="mcds-label-default" id="mc:236" for="mc:235">
                      Internal postcard name
                    </label>
                  </div>
...
export default PostCardRecurring;
