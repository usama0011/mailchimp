          ...
          >
            <div class="container-1xp3H">
              ...
              <p class="root-3TDqk medium-3AcAC subHeading-1b7r4">
                Design a landing page to achieve a specific marketing goal.
                Landing pages can help you attract new customers and increase
                conversion rate. What's your goal?
              </p>
              <form
              ...
              >
                <div class="root-2RFjU">
                  <div class="before-2EDUs">
                    <label class="mcds-label-default" id="mc:211" for="mc:210">
                      Landing page name
                    </label>
                  </div>
                ...
                <div class="root-1cS4q">
                  <div class="before-fjpii">
                    <label class="mcds-label-default" id="mc:216" for="mc:215">
                      Audience
                    </label>
                  </div>
                  <div class="selectWrapper-1gG6j">
                    <select id="mc:215" name="selectValue">
                      <option value="4955578">Next Web Lines</option>
                    </select>
                ...
                <p class="root-3TDqk medium-3AcAC selectSubLabel-1EJaA">
                  You'll be able to organize your audience based on contacts who
                  sign up from your landing page.
                </p>
                <div class="button-1iD64">
                  <button
                    class="root-sBgFt container-3-bH7 primary-33czz button-3mfLr"
                    type="submit"
                  >
                    <span class="temporarySpan-2iF2p">Begin</span>
                  </button>
                </div>
              </form>
            </div>
...
export default NewCampaingLandingPage;
